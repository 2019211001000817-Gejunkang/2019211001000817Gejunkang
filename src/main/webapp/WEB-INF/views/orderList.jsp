        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.GeJunKang.model.Order o=(com.GeJunKang.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.GeJunKang.dao.UserDao userDao= new com.GeJunKang.dao.UserDao() {
                            @Override
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.GeJunKang.model.Payment.findByPaymentId(con,n);
                        %>
